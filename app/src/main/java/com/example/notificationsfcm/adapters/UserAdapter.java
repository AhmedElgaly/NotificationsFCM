package com.example.notificationsfcm.adapters;
...
import com.example.notificationsfcm.R;
import com.example.notificationsfcm.models.UserModel;
import com.example.notificationsfcm.notification.API;
import com.example.notificationsfcm.notification.Client;
import com.example.notificationsfcm.notification.Data;
import com.example.notificationsfcm.notification.Response;
import com.example.notificationsfcm.notification.Sender;
                        ...
                        api.sendNotification(sender)
                                .enqueue(new Callback<Response>() {
                                    ...
                                    public void onResponse(Call<Response> call, retrofit2.Response<Response> response) {
                                        ...
                                        if (response.code() == 200) {
                                            ...
                                            if (response.body().success != 1) {
                                                Log.d(TAG, "adapter onResponse2: "+response.message());
                                            ...
                                            Log.d(TAG, " adapter onResponse3: "+response.message());
                                    ...
                                    public void onFailure(Call<Response> call, Throwable t) {
                                        ...
                                        Log.d(TAG, "adapter onResponse4: "+t.getMessage());
                                    }
                                });
